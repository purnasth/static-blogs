      ...
      <div className="flex flex-col gap-6 sm:flex-row sm:items-start md:gap-16">
        ...
        <div className="w-full shrink-0 sm:w-2/5">
          <Image
            ...
            width={1024}
            height={1024}
            className="pointer-events-none -z-10 h-48 w-full select-none object-contain object-bottom sm:h-52 sm:-translate-y-5 sm:scale-125 lg:scale-[1.85] xl:scale-[2.25]"
          />
        </div>
      </div>
    </div>
