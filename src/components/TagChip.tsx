...
export default function TagChip({ tag, count, size = "sm" }: Props) {
  return (
    <Link
      ...
      className={`inline-flex items-center gap-1.5 rounded-full border border-line bg-raised text-muted transition-colors hover:border-accent hover:text-accent ${
